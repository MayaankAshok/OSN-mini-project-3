...
main(int argc, char *argv[]) {
   ...
   c:	7e850513          	add	a0,a0,2024 # 7f0 <malloc+0xf0>
  10:	00000097          	auipc	ra,0x0
  14:	638080e7          	jalr	1592(ra) # 648 <printf>
    int x1= 1;
    if (fork()>0){
  18:	00000097          	auipc	ra,0x0
  1c:	2b0080e7          	jalr	688(ra) # 2c8 <fork>
  20:	02a05063          	blez	a0,40 <main+0x40>
    }
    else{
        x1 = 3;
        exit(0);
  ...
  2a:	7d250513          	add	a0,a0,2002 # 7f8 <malloc+0xf8>
  2e:	00000097          	auipc	ra,0x0
  32:	61a080e7          	jalr	1562(ra) # 648 <printf>
    exit(0);
  36:	4501                	li	a0,0
  38:	00000097          	auipc	ra,0x0
  3c:	298080e7          	jalr	664(ra) # 2d0 <exit>
        exit(0);
  40:	4501                	li	a0,0
...
malloc(uint nbytes)
{
 ...
 750:	8b490913          	add	s2,s2,-1868 # 1000 <freep>
  if(p == (char*)-1)
 754:	5afd                	li	s5,-1

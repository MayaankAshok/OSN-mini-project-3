...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3aa:	4aa50513          	add	a0,a0,1194 # 850 <digits>
 3ae:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ae:	34e70713          	add	a4,a4,846 # 7f8 <malloc+0x116>
 ...
 538:	31cb8b93          	add	s7,s7,796 # 850 <digits>
 ...
 58c:	26890913          	add	s2,s2,616 # 7f0 <malloc+0x10e>
        while(*s != 0){

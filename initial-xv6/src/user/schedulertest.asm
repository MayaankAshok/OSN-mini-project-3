...
int main()
{
  ...
  for (n = 0; n < NFORK; n++)
  {
   ...
   e:	2ec080e7          	jalr	748(ra) # 2f6 <fork>
    if (pid < 0)
  12:	02054663          	bltz	a0,3e <main+0x3e>
      break;
    if (pid == 0)
  16:	c90d                	beqz	a0,48 <main+0x48>
    pid = fork();
  18:	00000097          	auipc	ra,0x0
  1c:	2de080e7          	jalr	734(ra) # 2f6 <fork>
    if (pid < 0)
  20:	04054a63          	bltz	a0,74 <main+0x74>
  for (n = 0; n < NFORK; n++)
  24:	4489                	li	s1,2
    if (pid == 0)
  26:	c10d                	beqz	a0,48 <main+0x48>
      exit(0);
    }
  }
  for (; n > 0; n--)
  ...
  28:	fd840613          	add	a2,s0,-40
  2c:	fdc40593          	add	a1,s0,-36
  30:	4501                	li	a0,0
  32:	00000097          	auipc	ra,0x0
  36:	36c080e7          	jalr	876(ra) # 39e <waitx>
  for (; n > 0; n--)
  3a:	34fd                	addw	s1,s1,-1
  3c:	f4f5                	bnez	s1,28 <main+0x28>
      trtime += rtime;
      twtime += wtime;
    }
  }
  ...
  48:	fc042a23          	sw	zero,-44(s0)
  4c:	3b9ad737          	lui	a4,0x3b9ad
  50:	9ff70713          	add	a4,a4,-1537 # 3b9ac9ff <base+0x3b9ab9ef>
  54:	a031                	j	60 <main+0x60>
  56:	fd442783          	lw	a5,-44(s0)
  5a:	2785                	addw	a5,a5,1
  5c:	fcf42a23          	sw	a5,-44(s0)
  60:	fd442783          	lw	a5,-44(s0)
  64:	2781                	sext.w	a5,a5
  66:	fef758e3          	bge	a4,a5,56 <main+0x56>
      exit(0);
  6a:	4501                	li	a0,0
  6c:	00000097          	auipc	ra,0x0
  70:	292080e7          	jalr	658(ra) # 2fe <exit>
  for (n = 0; n < NFORK; n++)
  74:	4485                	li	s1,1
  76:	bf4d                	j	28 <main+0x28>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f6:	48e50513          	add	a0,a0,1166 # 880 <digits>
 3fa:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4fa:	33270713          	add	a4,a4,818 # 828 <malloc+0xfa>
 ...
 584:	300b8b93          	add	s7,s7,768 # 880 <digits>
 ...
 5d8:	24c90913          	add	s2,s2,588 # 820 <malloc+0xf2>
        while(*s != 0){
